...
import { ExternalLink, Github, Brain, Code, Database, Smartphone } from "lucide-react"
...
interface Project {
  ...
  isLive: boolean // Added isLive property to control demo button visibility
  impact: string
}
...
const projects: Project[] = [
  {
    ...
    category: "ai",
    description: "Email assistant that generates context-aware replies using Google Gemini API.",
    longDescription:
    ...
    status: "completed",
    isLive: false, // Not deployed, so no demo button
  ...
  },
  {
    ...
    githubUrl: "https://github.com/AyaanHimani/LetMeLocate-Indoor_Localization_using_Wi-Fi_Magnetometer.git",
    status: "completed",
    isLive: false, // Not deployed, so no demo button
    impact: "Enabled accurate indoor navigation for complex multi-floor environments",
  },
  {
    id: 3,
    title: "Course Management System",
    category: "fullstack",
    description: "Web platform for managing courses, attendance, assignments, quizzes, and administrative operations.",
    longDescription:
    ...
    technologies: ["MongoDB", "Express.js", "React", "Node.js", "Zustand", "JWT", "Cloudinary"],
    features: [
    ...
    status: "completed",
    isLive: true, // This is deployed and live
  ...
  "category": "fullstack",
  "description": "A full-stack platform for real-time tourist tracking, geofencing, and AI-powered anomaly detection and blockchain immutability.",
  ...
  "status": "completed",
  "isLive": false,
  "impact": "Enhances tourist safety through proactive, AI-driven monitoring, enabling authorities to respond to potential incidents before they escalate."
}
]
...
export function PortfolioSection() {
  ...
  return (
    <section id="portfolio" ref={sectionRef} className="py-20 lg:py-32 bg-muted/30 animate-on-scroll">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            A showcase of innovative solutions combining full-stack development with cutting-edge AI technologies.
          </p>
        </div>
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-xs sm:text-sm text-primary font-medium">{project.impact}</div>
